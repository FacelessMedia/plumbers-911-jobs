...
export function BenefitsSection() {
  return (
    <section id="benefits" className="bg-zinc-900 py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
            ...
            <span className="text-red-500">Protect Your Family</span>
          </h2>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {benefits.map((benefit) => (
            <div
              key={benefit.title}
              className="flex items-start gap-4 rounded-xl border border-white/5 bg-zinc-800/30 p-5 transition-all hover:border-red-600/20 hover:bg-zinc-800/50"
            >
              <div className="flex-shrink-0 rounded-lg bg-red-600/10 p-2.5">
                <benefit.icon className="h-5 w-5 text-red-500" />
              </div>
              <div>
